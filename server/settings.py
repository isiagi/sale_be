...
SECRET_KEY = 'django-insecure-i1#50uompu)vv@jv)$jifyjl6t!v9u*nfcbkc7du#8!e@b6#xu'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['sale-be.onrender.com','localhost', '127.0.0.1']
...
EMAIL_PORT = 587
EMAIL_HOST_USER = 'isiagigeofrey0@gmail.com'
EMAIL_HOST_PASSWORD = 'kxyh tanh bbsa xxer'
